namespace ouchernik.Web.Controllers
{
    ...
    using ouchernik.Data;

    public class AccountController : Controller
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;
        private OuchernikDbContext _db = new OuchernikDbContext();
        ...
        public ActionResult TeacherPartialView()
        {
            return PartialView("_RegisterTeacher");
        }

        public ActionResult StudentPartialView()
        {
